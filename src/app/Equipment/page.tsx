        ...
        <RadiantBox>
          ...
          {/* <div className="div" style={{ backgroundColor: effectiveBackgroundColor, borderColor: effectiveBorderColor }}>
            <div className="div-2">
              ...
              <div className="div-4" style={{ color: effectiveFontColor }}>
                <RadiantInputField inputType="text" label="" />
              </div>
            </div>
          </div>

          <div className="equipment-list" style={{ backgroundColor: effectiveBackgroundColor, borderColor: effectiveBorderColor }}>
          <div className="equipment-item">
            <div className="item-header">
              ...
              <button className="status" onClick={() => setEquipment("ENODEB")}>
          ...
          <div className="equipment-item">
            <div className="item-header">
              ...
              <button className="status" onClick={() => setEquipment("RADIO FRAME")}>
                <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/cff1665e195fade683fffd5ef347be1b6d6137d01b7753c47d4686c35ab19b01?apiKey=a938513dc279413eaac5ce0f8c637f66&" className="status-icon" />
                <div className="status-text">80%</div>
              </button>
            </div>
          ...
          <div className="equipment-item">
            <div className="item-header">
              ...
              <button className="status" onClick={() => setEquipment("CDMA 800 CELL")}>
                <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/cff1665e195fade683fffd5ef347be1b6d6137d01b7753c47d4686c35ab19b01?apiKey=a938513dc279413eaac5ce0f8c637f66&" className="status-icon" />
                <div className="status-text">80%</div>
              </button>
            </div>
          ...
          <div className="equipment-item">
            <div className="item-header">
              ...
              <button className="status" onClick={() => setEquipment("ENODEB 2")}>
                <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/cff1665e195fade683fffd5ef347be1b6d6137d01b7753c47d4686c35ab19b01?apiKey=a938513dc279413eaac5ce0f8c637f66&" className="status-icon" />
                <div className="status-text">80%</div>
              </button>
            </div>
          ...
          <div className="equipment-item">
            <div className="item-header">
              ...
              <button className="status" onClick={() => setEquipment("CDMA 800 CELL 2")}>
                <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/cff1665e195fade683fffd5ef347be1b6d6137d01b7753c47d4686c35ab19b01?apiKey=a938513dc279413eaac5ce0f8c637f66&" className="status-icon" />
                <div className="status-text">80%</div>
              </button>
            </div>
